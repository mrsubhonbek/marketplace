...
import { Product, ProductFile, User } from "@/back/payload-types";
...
const Page = async ({ searchParams }: PageProps) => {
  ...
  return (
    <main className="relative lg:min-h-full container">
      <div className="hidden lg:block h-80 overflow-hidden lg:absolute lg:h-full lg:w-1/2 ">
        <Image
          fill
      ...
      <div className="mx-auto max-w-2xl py-16  sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-24 lg:py-32 xl:gap-x-24">
